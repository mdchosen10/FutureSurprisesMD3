    ...
    <div className="mt-20">
      ...
      <div className="mt-10 flex flex-wrap gap-8 xl:flex-nowrap">
        <div className="flex w-full flex-col items-center px-5 py-10">
          ...
          <p className="mb-5 mt-14 text-center font-lora text-2xl font-bold 2xl:text-4xl">
            Plan the Surprise
          </p>
        ...
        <div className="flex w-full flex-col items-center rounded-[19px] bg-[#F2ECFF] px-5 py-10">
          <div className="relative flex h-[242px] min-w-[300px] max-w-[374px] items-center justify-center">
            <Image
              fill
          ...
          <p className="mb-5 mt-14 text-center font-lora text-2xl font-bold dark:text-secondary 2xl:text-4xl">
            {" "}
            We Handle the Rest
          </p>
          <p className="text-center text-lg 2xl:text-2xl">
